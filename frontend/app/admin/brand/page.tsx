"use client";
// app/admin/brand/page.tsx — Brand Identity under admin layout
    ...
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: sans, background: A.bg }}>
      ...
      <main style={{ flex: 1, overflowY: "auto", padding: "32px 36px 56px" }}>
        <div style={{ marginBottom: 28 }}>
          <div style={{ fontFamily: serif, fontSize: 26, fontWeight: 500, color: A.ink, letterSpacing: "-0.02em" }}>Brand Identity</div>
          <div style={{ fontSize: 13, color: A.muted, marginTop: 4 }}>System prompt, style guide and forbidden words for the AI pipeline</div>
        </div>
            ...
            <>
              <Card style={{ marginBottom: 24 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 20 }}>
                  <Btn onClick={save} disabled={saving} variant="primary" style={{ background: A.gold, border: `1px solid ${A.gold}` }}>
