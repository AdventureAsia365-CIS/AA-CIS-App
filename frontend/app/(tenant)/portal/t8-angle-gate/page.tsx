...
//
// AA-494 — AngleGateTab now reads useSearchParams() (?atom_id= from SlotPickerPanel's "Start
// writing" handoff), which requires a Suspense boundary or `next build` fails prerendering this
